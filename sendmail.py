...
if __name__ == '__main__':
   ...
   MAPIProfile = 'mark.carter'
   SendTo = 'alt.mcarter@gmail.com'
   SendCC = None
   SendBCC = None
   SendSubject = 'some subject'
   SendMessage = 'this is supposed to be the body of the message'
   ...
   print 'Finished'
## end of http://code.activestate.com/recipes/149461/ }}}
